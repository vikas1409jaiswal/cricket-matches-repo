...
export const modifyTeamName = (teamName: string) => {
  ...
  switch (teamName) {
    case "Royal Challengers Bengaluru":
      ...
      break;
    case "Central Districts":
      modTeamName = "Central Stags";
      break;
    case "Otago":
      modTeamName = "Otago Volts";
      break;
    case "Wellington":
      modTeamName = "Wellington Firebirds";
      break;
    case "Canterbury":
      modTeamName = "Canterbury Kings";
      break;
    case "Auckland":
      modTeamName = "Auckland Aces";
      break;
    case "Durban's Super Giants":
      modTeamName = "Durban Super Giants";
      break;
    case "B'desh U19":
      modTeamName = "Bangladesh Under 19";
      break;
    case "USA U19":
      modTeamName = "USA Under 19";
      break;
    case "India U19":
      modTeamName = "India Under 19";
      break;
    case "RCB Women":
      modTeamName = "Royal Challengers Bangalore Women";
      break;
    case "GG Women":
      modTeamName = "Gujarat Giants Women";
      break;
    case "DC Women":
      modTeamName = "Delhi Capitals Women";
      break;
    case "MI Women":
      modTeamName = "Mumbai Indians Women";
      break;
    case "UPW Women":
      modTeamName = "UP Warriorz Women";
      break;
  }
  return modTeamName;
};
